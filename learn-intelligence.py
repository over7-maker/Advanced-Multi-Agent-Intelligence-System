    ...
    sample_tasks = [
        {
            ...
            "task_type": random.choice(
                ["security_scan", "code_analysis", "intelligence_gathering"]
            ),
            "target": f"example{i}.com",
            "parameters": {
                "depth": random.choice(["quick", "standard", "comprehensive"])
            },
            "agents_used": random.sample(
                ["security_expert", "code_analysis", "intelligence_gathering"],
                random.randint(1, 3),
            ),
