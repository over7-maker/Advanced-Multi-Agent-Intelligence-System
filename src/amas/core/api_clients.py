...
class BaseAPIClient:
    ...
    async def generate_streaming(self, messages: List[Dict], **kwargs) -> AsyncGenerator[APIResponse, None]:
...
class APIClientFactory:
    ...
    @staticmethod
    def create_client(api_name: str, api_key: str, base_url: str, model: str) -> BaseAPIClient:
...
async def get_client(api_name: str, api_key: str, base_url: str, model: str) -> BaseAPIClient:
    """Get an API client instance"""
    return APIClientFactory.create_client(api_name, api_key, base_url, model)

async def test_api_client(api_name: str, api_key: str, base_url: str, model: str) -> bool:
