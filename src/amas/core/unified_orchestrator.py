...
class UnifiedOrchestrator:
    ...
    def _initialize_agents(self):
        ...
        agent_configs = [
            AgentConfig(
                ...
                priority_models=["deepseek/deepseek-chat", "openai/gpt-4", "meta-llama/llama-3.1-70b"],
                capabilities=["code_review", "performance_analysis", "architecture_assessment"]
            ),
            AgentConfig(
                ...
                priority_models=["openai/gpt-4", "anthropic/claude-3-opus", "deepseek/deepseek-chat"],
                capabilities=["vulnerability_scan", "threat_assessment", "security_recommendations"]
            ),
            AgentConfig(
                ...
                priority_models=["deepseek/deepseek-chat", "openai/gpt-3.5-turbo", "meta-llama/llama-3.1-70b"],
                capabilities=["osint_collection", "threat_intelligence", "data_aggregation"]
            ),
            AgentConfig(
                ...
                priority_models=["openai/gpt-4", "deepseek/deepseek-chat", "anthropic/claude-3-opus"],
                capabilities=["incident_triage", "response_planning", "mitigation_strategies"]
            ),
            AgentConfig(
                ...
                priority_models=["deepseek/deepseek-chat", "openai/gpt-4", "meta-llama/codellama-34b"],
            ...
            AgentConfig(
                ...
                priority_models=["deepseek/deepseek-chat", "openai/gpt-4", "meta-llama/llama-3.1-70b"],
                capabilities=["performance_profiling", "optimization_recommendations", "bottleneck_analysis"]
            ),
            AgentConfig(
            ...
            AgentConfig(
                ...
                priority_models=["openai/gpt-4", "anthropic/claude-3-opus", "deepseek/deepseek-chat"],
                capabilities=["project_planning", "task_coordination", "progress_tracking"]
            )
        ]
    ...
    def _prepare_agent_prompt(
        ...
        if parameters:
            prompt_parts.append(f"Additional context: {json.dumps(parameters, indent=2)}")
        ...
        if task.results:
            ...
            if other_results:
                prompt_parts.append(f"Input from other agents: {json.dumps(other_results, indent=2)}")
    ...
    async def analyze_project(
        ...
        if analysis_types is None:
            analysis_types = ["code_quality", "security", "performance", "documentation"]
        ...
        analysis_agent_map = {
            ...
            "intelligence": [AgentRole.INTELLIGENCE_GATHERER, AgentRole.OSINT_COLLECTOR],
