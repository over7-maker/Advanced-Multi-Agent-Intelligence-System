...
class InteractiveLogger:
    ...
    def _log_entry(self, level: str, message: str, **kwargs):
        ...
        self.performance_metrics["average_log_size"] = (
            (current_avg * (total_logs - 1) + log_size) / total_logs
        )
    ...
    def agent_activity(self, agent_id: str, action: str, task_id: Optional[str] = None, **kwargs):
        """Log agent activity"""
    ...
    def display_log_summary(self):
        ...
        for log_type, log_file in log_files:
            ...
            size = f"{log_file.stat().st_size / 1024:.1f} KB" if log_file.exists() else "N/A"
    ...
    def clear_old_logs(self, days: int = 30):
        ...
        try:
            ...
            for log_file in [self.main_log_file, self.error_log_file, self.performance_log_file, self.audit_log_file]:
                if log_file.exists():
            ...
            self.console.print(f"✅ Cleared {cleared_count} old log files", style="green")
