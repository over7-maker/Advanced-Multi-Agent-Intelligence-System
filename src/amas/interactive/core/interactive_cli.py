...
class AMASInteractiveCLI:
    ...
    def setup_system(self):
        ...
        try:
            self.console.print("🚀 Initializing AMAS Interactive System...", style="bold cyan")
            ...
            self.agent_coordinator = AgentCoordinator(self.orchestrator, config.get('agents', {}))
            ...
            self.console.print("✅ AMAS Interactive System initialized successfully!", style="bold green")
...
╚══════════════════════════════════════════════════════════════════════════════╝
    ...
    async def _generate_task_results(self, task: Task, task_config: Dict[str, Any]) -> Dict[str, Any]:
...
- Use `--priority high` for urgent tasks
    ...
    def show_status(self):
        ...
        # Core system
        status_table.add_row("🤖 Multi-Agent System", "✅ Active", f"{len(self.agent_coordinator.agents)} agents ready")
        ...
        status_table.add_row("🎯 Intent Classifier", "✅ Ready", "AI-powered command interpretation")
        ...
        status_table.add_row("💾 Memory Usage", "✅ Normal", f"{self._get_memory_usage():.1f}MB")
    ...
    def _display_performance_metrics(self):
        ...
        metrics_table.add_row("Agents Utilized", str(len(self.metrics["agents_utilized"])))
    ...
    def _display_history_summary(self):
        ...
        summary_table.add_row("Success Rate", f"{(completed_tasks/total_tasks*100):.1f}%")
