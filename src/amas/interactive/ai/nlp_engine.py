...
class NLPEngine:
        ...
        try:
            ...
            if self.nlp_model:
                ...
                for ent in doc.ents:
                    ...
                    if not any(e.text == ent.text and e.start == ent.start_char for e in entities):
                        entity = Entity(
                            text=ent.text,
                            label=ent.label_,
                    ...
                    if match:
                        ...
                        if confidence > best_intent.confidence:
                            best_intent = Intent(
                                ...
                                parameters={"match": match.group(1) if match.groups() else ""},
                                metadata={"pattern": pattern}
                            )
    ...
    def _keyword_based_intent_classification(self, text: str, entities: List[Entity]) -> Intent:
        """Fallback keyword-based intent classification"""
        keywords = {
            "security_scan": ["scan", "security", "vulnerability", "audit", "check"],
            "code_analysis": ["code", "analyze", "review", "quality", "function"],
            "intelligence_gathering": ["research", "investigate", "intelligence", "osint", "gather"],
            "performance_monitoring": ["monitor", "performance", "optimize", "speed", "memory"],
            "documentation_generation": ["document", "docs", "write", "generate", "create"],
            ...
            if matches > 0:
                ...
                if confidence > best_intent.confidence:
                    best_intent = Intent(
                        ...
                        parameters={"matched_keywords": list(text_words.intersection(set(intent_keywords)))}
                    )
    ...
    def _analyze_sentiment(self, text: str) -> str:
        ...
        positive_words = ["good", "great", "excellent", "amazing", "perfect", "awesome", "fantastic"]
    ...
    def _generate_suggestions(self, text: str, intent: Intent, entities: List[Entity]) -> List[str]:
    ...
    def _update_performance_stats(self, processing_time: float):
        ...
        total_time = self.processing_stats["average_processing_time"] * self.processing_stats["commands_processed"]
        total_time += processing_time
        self.processing_stats["average_processing_time"] = total_time / self.processing_stats["commands_processed"]
    ...
    def display_analysis(self, analysis: Dict[str, Any]):
        ...
        table.add_row("Intent", f"{analysis['intent']['name']} ({analysis['intent']['confidence']:.1%})")
