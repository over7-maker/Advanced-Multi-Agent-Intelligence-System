...
class UnifiedAIRouter:
    ...
    def _load_configuration(self, config_path: Optional[str] = None):
        ...
        openrouter_key = os.getenv('OPENROUTER_API_KEY') or os.getenv('DEEPSEEK_API_KEY')
    ...
    def _initialize_clients(self):
        ...
        for model_id, config in self.models.items():
            try:
                if config.provider in [ModelProvider.OPENROUTER, ModelProvider.DEEPSEEK_DIRECT, 
                                      ModelProvider.OPENAI_DIRECT, ModelProvider.GLM_DIRECT]:
                ...
                elif config.provider in [ModelProvider.LOCAL_LLAMA, ModelProvider.LOCAL_CODELLAMA]:
    ...
    async def complete(
        ...
        **kwargs
        ...
        if model_preference and model_preference in self.models:
            available_models.insert(0, (model_preference, self.models[model_preference]))
