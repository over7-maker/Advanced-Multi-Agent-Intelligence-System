...
class MetadataAgent(IntelligenceAgent):
    ...
    async def validate_task(self, task: Dict[str, Any]) -> bool:
        ...
        metadata_keywords = [
            'metadata', 'timeline', 'steganography', 'hidden',
            'file', 'analysis', 'extraction', 'correlation'
        ]
    ...
    async def _perform_general_metadata_analysis(self, task: Dict[str, Any]) -> Dict[str, Any]:
