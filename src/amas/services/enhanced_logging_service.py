...
class EnhancedLogger:
    ...
    def log_http_request(self, method: str, url: str, status_code: int, 
                        duration_ms: float, request_size: int = None, 
    ...
    def log_performance(self, operation: str, duration_ms: float, 
                       memory_usage_mb: float = None, cpu_usage_percent: float = None, **kwargs):
    ...
    def log_business_event(self, event: str, value: float = None, 
    ...
    def log_error(self, error: Exception, context: str = None, **kwargs):
        ...
        self.error(
            ...
            stack_trace=traceback.format_exc() if self.config.include_stack_traces else None,
            **kwargs
        )
...
class LoggingContext:
    ...
    def __init__(self, correlation_id: str = None, user_id: str = None, 
                 session_id: str = None, request_id: str = None, trace_id: str = None):
...
def log_with_context(correlation_id: str = None, user_id: str = None, 
                    session_id: str = None, request_id: str = None, trace_id: str = None):
    """Decorator for logging with context"""
    
    def decorator(func):
        def wrapper(*args, **kwargs):
            with LoggingContext(correlation_id, user_id, session_id, request_id, trace_id):
