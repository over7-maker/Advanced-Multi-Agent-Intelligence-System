...
class PrometheusMetricsService:
    ...
    def update_system_metrics(self):
        ...
        try:
            ...
            self.metrics["system_memory_usage_bytes"].labels(type="used").set(memory.used)
            self.metrics["system_memory_usage_bytes"].labels(type="available").set(memory.available)
            self.metrics["system_memory_usage_bytes"].labels(type="total").set(memory.total)
