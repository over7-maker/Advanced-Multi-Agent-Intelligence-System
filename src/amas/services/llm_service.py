...
class LLMService:
    ...
    async def generate_response(
        ...
        try:
            if provider == "ollama":
                ...
                return await self._generate_glm_response(
                    prompt, model, temperature, max_tokens
                )
            elif provider == "grok":
    ...
    async def _generate_deepseek_response(
        ...
        try:
            ...
            response = await self.client.post(
                self.api_endpoints["deepseek"], headers=headers, json=payload
            )
    ...
    async def _generate_glm_response(
        self,
        prompt: str,
        model: Optional[str] = None,
        temperature: float = 0.7,
        ...
        try:
            ...
            response = await self.client.post(
                self.api_endpoints["glm"], headers=headers, json=payload
            )
    ...
    async def _generate_grok_response(
        ...
        try:
            ...
            response = await self.client.post(
                self.api_endpoints["grok"], headers=headers, json=payload
            )
