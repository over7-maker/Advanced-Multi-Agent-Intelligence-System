...
DB_CONNECTIONS_ACTIVE = Gauge(
    "amas_db_connections_active", "Active database connections"
)
...
DB_QUERY_DURATION = Histogram(
    "amas_db_query_duration_seconds", "Database query duration", ["query_type"]
)
DB_QUERY_COUNT = Counter(
    "amas_db_queries_total", "Total database queries", ["query_type", "status"]
)
DB_CONNECTION_ERRORS = Counter(
    "amas_db_connection_errors_total", "Database connection errors"
)
...
class AsyncConnectionPool:
    ...
    async def execute_query(
        self, query: str, *args, query_type: str = "unknown"
    ) -> Any:
...
class SyncConnectionPool:
    ...
    def initialize(self):
        ...
        try:
            ...
            logger.info(
                f"Sync database connection pool initialized: {self.min_connections}-{self.max_connections} connections"
            )
        except Exception as e:
    ...
    def execute_query(
        self, query: str, params: tuple = (), query_type: str = "unknown"
    ) -> List[tuple]:
        """Execute a query with monitoring"""
        start_time = time.time()
        connection = None
