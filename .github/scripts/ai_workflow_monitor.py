...
class AIWorkflowMonitor:
    ...
    async def perform_workflow_monitoring(self) -> Dict[str, Any]:
        ...
        performance_analysis = await self.call_agent(performance_agent, performance_prompt, health_analysis)
        if not performance_analysis:
            performance_analysis = "Performance analysis failed - using health analysis only"
        ...
        strategic_insights = await self.call_agent(strategy_agent, strategy_prompt, performance_analysis)
        if not strategic_insights:
            strategic_insights = "Strategic insights failed - review performance analysis"
        ...
        technical_recommendations = await self.call_agent(technical_agent, technical_prompt, strategic_insights)
        if not technical_recommendations:
            technical_recommendations = "Technical recommendations failed - review strategic insights"
