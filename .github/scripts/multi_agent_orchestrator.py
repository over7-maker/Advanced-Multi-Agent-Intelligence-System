...
class MultiAgentOrchestrator:
        ...
        try:
            ...
            response = agent["client"].chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": f"You are {agent['role']} for the AMAS Intelligence System. {agent['description']}",
                    },
    ...
    async def run_intelligence_analysis(self) -> Dict[str, Any]:
        ...
        analysis_result = await self.call_agent(
            analysis_agent, analysis_prompt, osint_result
        )
        ...
        strategy_result = await self.call_agent(
            strategy_agent, strategy_prompt, analysis_result
        )
