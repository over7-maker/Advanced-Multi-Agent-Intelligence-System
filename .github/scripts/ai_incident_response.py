...
class AIIncidentResponse:
    ...
    def analyze_incident_severity(self, title: str, body: str) -> str:
        ...
        # Critical indicators
        critical_indicators = ['critical', 'urgent', 'breach', 'compromise', 'attack', 'exploit', 'zero-day']
        high_indicators = ['high', 'severe', 'malware', 'phishing', 'suspicious', 'anomaly']
    ...
    async def process_incident(self) -> Dict[str, Any]:
        ...
        threat_analysis = await self.call_agent(analysis_agent, threat_prompt, incident_assessment)
        ...
        response_strategy = await self.call_agent(strategy_agent, strategy_prompt, threat_analysis)
        ...
        technical_response = await self.call_agent(technical_agent, technical_prompt, response_strategy)
