...
class AIIssueResponder:
    ...
    def analyze_issue_type(self, title: str, body: str) -> str:
        ...
        if any(
            word in title_lower or word in body_lower
            for word in ["bug", "error", "broken", "crash", "fail"]
        ):
            return "bug"
        elif any(
            word in title_lower or word in body_lower
            for word in ["feature", "enhancement", "add", "implement"]
        ):
            return "feature_request"
        elif any(
            word in title_lower or word in body_lower
            for word in ["question", "how to", "help", "?"]
        ):
            return "question"
        elif any(
            word in title_lower or word in body_lower
            ...
            word in title_lower or word in body_lower
            for word in ["performance", "slow", "optimization"]
        ):
            return "performance"
        elif any(
            word in title_lower or word in body_lower
