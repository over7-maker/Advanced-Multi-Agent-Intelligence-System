...
class TestErrorHandling:
    ...
    async def test_task_execution_failure(self):
        ...
        with patch.object(orchestrator.api_manager, 'generate_response') as mock_generate:
...
def create_mock_api_response(content: str = "Test response", api_used: str = "test_api") -> Dict[str, Any]:
