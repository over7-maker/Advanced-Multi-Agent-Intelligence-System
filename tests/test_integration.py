...
class TestSystemIntegration:
    ...
    @pytest.mark.asyncio
    async def test_end_to_end_task_processing(self, amas_app, test_client: httpx.AsyncClient):
        ...
        for attempt in range(max_attempts):
            status_response = await test_client.get(f"/tasks/{task_id}", headers=headers)
