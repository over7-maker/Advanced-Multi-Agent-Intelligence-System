...
```"""
        ...
        try:
            ...
            test_report = {
                ...
                'summary': self._generate_test_summary(
                    provider_tests, capability_tests, script_tests,
                    workflow_tests, environment_tests
                )
            }
    ...
    def _generate_test_summary(self, provider_tests: Dict[str, Any],
    ...
    def _generate_test_recommendations(self, successful_providers: int,
        ...
        if successful_providers > 0 and successful_capabilities > 0 and working_scripts > 0:
            recommendations.append("AI integration is working well! Consider running performance tests.")
...
async def main():
    ...
    parser.add_argument('--output', default='complete_ai_integration_test_report.json', help='Output file for test report')
    parser.add_argument('--providers-only', action='store_true', help='Only test AI providers')
    parser.add_argument('--capabilities-only', action='store_true', help='Only test AI capabilities')
    parser.add_argument('--scripts-only', action='store_true', help='Only test AI scripts')
    parser.add_argument('--workflow-only', action='store_true', help='Only test GitHub Actions workflow')
