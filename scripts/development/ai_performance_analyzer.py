...
class AIPerformanceAnalyzer:
    ...
    async def analyze_file_performance(
        ...
        try:
            ...
            optimization_recommendations = (
                await self._generate_optimization_recommendations(content, language)
            )
            ...
            performance_score = await self._calculate_performance_score(
                ...
                (
                    optimization_recommendations.content
            ...
            return {
                ...
                "performance_metrics": (
                    performance_metrics.content if performance_metrics.success else None
                ),
...
Provide specific metrics and monitoring strategies."""
    ...
    async def _calculate_performance_score(
        self, analysis_content: str, optimization_content: str
    ) -> int:
    ...
    async def analyze_directory_performance(
        ...
        try:
            ...
            for file_path in files:
                ...
                analysis_result = await self.analyze_file_performance(
                    str(file_path), analysis_type
                )
                ...
                if "performance_analysis" in analysis_result:
                    ...
                    performance_file_name = (
                        f"{relative_path.stem}_performance_report.md"
                    )
                    output_file = output_path / performance_file_name

                    with open(output_file, "w", encoding="utf-8") as f:
                        f.write(
                            f"# Performance Analysis Report for {relative_path}\n\n"
                        )
                        f.write(
                            f"**Performance Score:** {analysis_result.get('performance_score', 'N/A')}/10\n\n"
                        )
            ...
            # Generate summary
            results["summary"] = await self._generate_performance_summary(
    ...
    try:
        ...
        if args.files:
            ...
            for file_path in args.files:
                ...
                analysis_result = await analyzer.analyze_file_performance(
                    file_path, args.analysis_type
                )
                results["performance_reports"].append(analysis_result)
                if "performance_analysis" in analysis_result:
                    results["files_analyzed"] += 1
            ...
            # Generate summary
            results["summary"] = await analyzer._generate_performance_summary(
                results["performance_reports"]
            )
        ...
        logger.info(
            f"Performance analysis complete. {results['files_analyzed']} files analyzed."
        )
