    ...
    async def generate_documentation_for_file(self, file_path: str, doc_type: str = "comprehensive") -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'api_documentation': api_doc_response.content if api_doc_response.success else None,
                'usage_examples': examples_response.content if examples_response.success else None,
                'doc_type': doc_type,
...
async def main():
    ...
    parser.add_argument('--files', nargs='+', help='Files to generate documentation for')
    ...
    parser.add_argument('--doc-type', default='comprehensive',
