...
def main():
    ...
    parser.add_argument('--output', default='yaml_syntax_fix_report.json', help='Output file for fix report')
    ...
    try:
        ...
        for workflow, fixes in results.get('workflow_fixes', {}).items():
            ...
            print(f"  Run Commands: {fixes.get('run_commands', {}).get('fixes_applied', 0)}")
