...
async def main():
    ...
    parser.add_argument(
        "--mode",
        choices=["full_analysis", "quality_only", "security_only", "performance_only"],
        default="full_analysis",
        help="Analysis mode",
    )
    parser.add_argument(
        "--output", default="continuous_improvements.md", help="Output file"
    )
